...
import { findHospital } from "@/features/admin/dashboard/hospitals/services/hospitalService";
...
export default async function DashboardEditHospitalPage({ params }: Params) {
			...
			<Topbar>
				<div className="flex items-center gap-6 h-[102px] bg-white w-full rounded-3xl p-[18px]">
					<div className="flex flex-col gap-2 w-full">
						<h1 className="font-bold text-2xl capitalize">Edit Hospital</h1>
						<Link
